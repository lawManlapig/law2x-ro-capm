...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "eqinv/test/integration/FirstJourney",
    "eqinv/test/integration/EquipmentTypesSetListJourney",
    "eqinv/test/integration/EquipmentTypesSetObjectPageJourney",
    "eqinv/test/integration/EquipmentsSetObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
